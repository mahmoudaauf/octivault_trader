...
from system_state_manager import ContextRecoveryEngine, SystemStateManager
...
def check_and_recover():
    ...
    if restart_detected:
        ...
        # Record recovery
        state_manager.update_operational_state(data={"last_boot": datetime.now().isoformat()})
        ...
        return {"restart_detected": True, "recovered": True, "context": full_context}
        ...
        return {"restart_detected": False, "recovered": True, "context": full_context}
