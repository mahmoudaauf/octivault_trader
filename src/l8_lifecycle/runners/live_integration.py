...
def initialize_live_environment():
    ...
    state_mgr.update_operational_state(phase="live_trading", task="continuous_portfolio_management")
    ...
    def decorator(func):
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                state_mgr.record_task_completion(task=operation_name, status="success")
                return result
            except Exception as e:
                state_mgr.record_error(error=str(e), context=operation_name)
                raise
