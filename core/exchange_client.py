...
- Hygiene guards → NOTIONAL/MIN_NOTIONAL, MARKET_LOT_SIZE/LOT_SIZE.stepSize, per-symbol throttle, weight guard
    ...
    # (Exec results & portfolio/balances events are emitted by ExecutionManager/PortfolioMgr)
...
# Allows "from core.exchange_client import ExchangeClient" to work
# even if this module is loaded from a different location.
# -----------------------------------------
import sys as _sys
from pathlib import Path as _Path
# Ensure current directory on sys.path so local runs can resolve sibling modules
try:
    ...
    pass
    # Register canonical core.* alias so both 'core.exchange_client' and 'exchange_client' work
    ...
    except Exception:  # fail-safe shim
