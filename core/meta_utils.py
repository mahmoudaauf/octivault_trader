"""
Utility classes and functions for MetaController and related modules.
"""
...
class ExecutionError(Exception):
    ...
    def __init__(self, error_type: str, message: str, symbol: str = "", context: Optional[Dict[str, Any]] = None):
