...
def test_rounding():
    ...
    for test in tests:
        ...
        if original_result == test["expected_down"]:
            print("   ✅ Original DOWN matches expected")
            passed += 1
        else:
        ...
        if fixed_down == test["expected_down"]:
            print("   ✅ Fixed DOWN matches expected")
            passed += 1
        else:
        ...
        if fixed_up == test["expected_up"]:
            print("   ✅ Fixed UP matches expected")
            passed += 1
        else:
...
def test_doge_case():
    ...
    print("  Problem: Dust not included in SELL order!")
    ...
    print("  Result: Entire position sold, zero dust!")
