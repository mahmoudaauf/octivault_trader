...
async def test_position_model():
    ...
    try:
        ...
        from src.l0_core.shared_state import AssetClassification, ClassifiedPosition
...
async def test_exit_metrics():
    ...
    try:
        ...
        tracker.record_exit(
            "TAKE_PROFIT", entry_price=100.0, exit_price=102.5, quantity=0.1, hold_time_sec=1200
        )
        tracker.record_exit(
            "STOP_LOSS", entry_price=100.0, exit_price=98.5, quantity=0.1, hold_time_sec=600
        )
        tracker.record_exit(
            "TIME_BASED", entry_price=100.0, exit_price=101.0, quantity=0.1, hold_time_sec=14400
        )
...
if __name__ == "__main__":
    ...
    print("   Testing: Entry Gate | Exit Monitor | Position Model | Exit Metrics")
