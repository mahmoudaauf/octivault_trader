...
async def run_30min_test():
    ...
    if recovery_result["restart_detected"]:
        print("✅ Recovered from previous restart")
    ...
    state_mgr.update_operational_state(phase="phase4_test", task="30_minute_validation_test")
    ...
    try:
        ...
        print(
            f"Test status:             {'✅ PASSED' if monitor.total_errors == 0 else '❌ FAILED'}"
        )
        ...
        state_mgr.record_error(error=str(e), context="30_minute_test_run")
        return False
