...
class ConfigLoader:
    ...
    def _load_trading(self):
        ...
        self._config["TRADING"] = ConfigGroup("TRADING", {
    ...
    def _load_risk(self):
        ...
        self._config["RISK"] = ConfigGroup("RISK", {
    ...
    def _load_profit_taking(self):
        ...
        self._config["PROFIT_TAKING"] = ConfigGroup("PROFIT_TAKING", {
    ...
    def _load_api(self):
        ...
        self._config["API"] = ConfigGroup("API", {
    ...
    def get_all(self) -> Dict[str, Dict[str, Any]]:
        ...
        """
        return {
            group_name: group.values.copy()
            for group_name, group in self._config.items()
        }
