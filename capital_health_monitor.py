...
def print_analysis(analysis: Dict) -> None:
    ...
    print(f"   Net Change:        ${analysis['nav_change']:+.2f} ({analysis['nav_change_pct']:+.2f}%)")
    ...
    if analysis['nav_change'] < -5:
        ...
        print(f"   Action: Review strategy, tighten filters, increase position size")
    elif analysis['nav_change'] > 5:
        print(f"   ✅ CAPITAL GROWING: Gained ${analysis['nav_change']:.2f}")
        print(f"   Status: Strategy is profitable")
    else:
        print(f"   ⏸️  CAPITAL STABLE: Change of ${analysis['nav_change']:.2f}")
        print(f"   Status: Breakeven or low activity period")
