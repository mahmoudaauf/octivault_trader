...
try:
    from src.l0_core.shared_state import Component as _ComponentEnum  # optional
except Exception:
    _ComponentEnum = None


try:
    from src.l0_core.shared_state import HealthCode as _HealthEnum  # optional
except Exception:
    _HealthEnum = None

# ── ExchangeClient lazy public bootstrap (optional) ───────────────────────────
try:
    from src.l1_exchange.exchange_client import ensure_public_bootstrap as _ensure_ec_public
except Exception:
