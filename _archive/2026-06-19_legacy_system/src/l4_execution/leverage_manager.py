    ...
    async def validate_position_leverage(
        ...
        try:
            ...
            if account_balance <= 0:
                return False, LeverageStatus.REJECTED_INVALID, "Invalid account balance", 0.0
            ...
            if calculated_leverage > self.max_leverage:
                ...
                return (
                    False,
                    LeverageStatus.REJECTED_EXCEEDS_MAX,
...
class LeverageMonitor:
    ...
    def calculate_portfolio_leverage(self, account_balance: float) -> float:
        ...
        total_value = sum(pos["quantity"] * pos["entry_price"] for pos in self.positions.values())
    ...
    async def validate_portfolio_leverage(
        ...
        try:
            ...
            total_value = (
                sum(pos["quantity"] * pos["entry_price"] for pos in self.positions.values())
                + new_position_value
            )
