...
def print_status():
    ...
    if metrics:
        ...
        print(f"\n📊 LATEST METRICS")
        print(f"   Status:  🔴 NO METRICS (waiting for first cycle...)")
    ...
    # 6. Quick Actions
    print(f"\n🔧 QUICK ACTIONS")
    print(f"   Start:   ./start_trading_with_monitoring.sh")
    print(f"   Monitor: python -m monitoring.active_capital_monitor")
    print(f"   Dashboard: python monitoring/real_time_dashboard.py")
    print(f"   Guide:   cat MONITORING_GUIDE.md")
